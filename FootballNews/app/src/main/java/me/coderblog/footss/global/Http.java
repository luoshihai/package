package me.coderblog.footss.global;
...
public class Http {
    ...
    public static final String URL_TOP = "https://api.dongqiudi.com/app/tabs/android/1.json";   //头条

    public static final String URL_COLLECTION = "https://api.dongqiudi.com/app/tabs/android/11.json";   //集锦
    public static final String URL_VIDEO = "https://api.dongqiudi.com/app/tabs/android/43.json";   //视频
    public static final String URL_Transfer = "https://api.dongqiudi.com/app/tabs/android/83.json";   //转会

    public static final String URL_SUBJECT = "https://api.dongqiudi.com/app/tabs/classifications.json";   //专题
    public static final String URL_DEEP = "https://api.dongqiudi.com/app/tabs/android/55.json";   //深度

    public static final String URL_CHINA = "https://api.dongqiudi.com/app/tabs/android/56.json";   //中超
    public static final String URL_ENGLAND = "https://api.dongqiudi.com/app/tabs/android/3.json"; //英超
    public static final String URL_SPAIN = "https://api.dongqiudi.com/app/tabs/android/5.json";   //西甲
    public static final String URL_GERMANY = "https://api.dongqiudi.com/app/tabs/android/6.json"; //德甲
    public static final String URL_ITALY = "https://api.dongqiudi.com/app/tabs/android/4.json";   //意甲
    public static final String URL_GLOBAL = "https://api.dongqiudi.com/app/tabs/android/57.json";   //五洲
