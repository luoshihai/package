...
public class DayBallActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_day_ball);
        ButterKnife.bind(this);
        initView();
    }

    private void initView() {
        titleName.setText("天天推球");
        ...
        mWebView.loadUrl("http://5.9188.com/activity/ttjx/?from=app&from=android&imei=QjczNEY3MjcxQzhEMzQzQ0E2RDcwMUIwOTNCMUYwMEE=&appversion=14520&source=1400&osversion=5.1.1&mtype=1");
