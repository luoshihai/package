...
import com.saadsdasd.niuniu.adapter.NewsAdapter;
import com.saadsdasd.niuniu.base.KBaseFragment;
import com.saadsdasd.niuniu.model.NewModel;
...
public class FootBallNewsFragment extends KBaseFragment implements SwipeRefreshLayout.OnRefreshListener {
    ...
    private void getData(){
        ...
        final Request request = new Request.Builder()
                .url("http://mapi.159cai.com/discovery/news/football/index.json").build();
