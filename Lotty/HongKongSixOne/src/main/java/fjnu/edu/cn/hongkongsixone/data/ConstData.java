package fjnu.edu.cn.hongkongsixone.data;

import android.support.v4.content.ContextCompat;

import fjnu.edu.cn.hongkongsixone.R;
import fjnu.edu.cn.hongkongsixone.fragment.DiscoveryFragment;
import fjnu.edu.cn.hongkongsixone.fragment.HomeFragment;
import fjnu.edu.cn.hongkongsixone.fragment.MyFragment;
...
public class ConstData {
    ...
    public static final String ABOUT_MESSAGE = "北京赛车开奖查询软件";
    //开奖数据获取
//    public static final String LOTTERY_URL = "http://api.jisuapi.com/caipiao/history?appkey=c9489362e98ad0d2&caipiaoid=82&issueno=&start=0&num=20";
    public static final String LOTTERY_URL = "http://api.jisuapi.com/caipiao/history?appkey=c9489362e98ad0d2&caipiaoid=82&issueno=&start=0&num=20";
    //视频数据获取
     ...
     * 底部导航栏的图片正常显示
     */
    public static final int[] TAB_IMGS = new int[]{R.mipmap.home_normal, R.mipmap.message_normal, R.mipmap.my_normal};
    /**
     * 底部导航栏的文字正常显示
     */
     ...
     * 底部导航栏的图片选中显示
     */
    public static final int[] TAB_SELECT_IMGS = new int[]{R.mipmap.home_select_blue,  R.mipmap.message_select_blue, R.mipmap.my_select_blue};
    /**
     * TAB项的文字是否显示
     */
    ...
    public interface IntentKey{
        ...
        String IS_LOAD_CHART = "is_load_chart";
