...
public class ConstData {
     ...
     * ManiActivity内容页面
     */
    public static final Class<?>[] CONTENT_FRAGMENTS = new Class[]{HomeFragment.class, DiscoveryFragment.class, MessageFragment.class, ToolkitFragment.class, MyFragment.class};
    /**
     * 底部导航项的文字显示
     */
