package fjnu.edu.cn.bjk3js.data;

import android.support.v4.content.ContextCompat;

import fjnu.edu.cn.bjk3js.R;
import fjnu.edu.cn.bjk3js.fragment.DiscoveryFragment;
import fjnu.edu.cn.bjk3js.fragment.HomeFragment;
import fjnu.edu.cn.bjk3js.fragment.MyFragment;
...
public class ConstData {
    ...
    public static final String ABOUT_MESSAGE = "方便的北京快3查询软件";
    //开奖数据获取
    public static final String LOTTERY_URL = "http://api.jisuapi.com/caipiao/history?appkey=c9489362e98ad0d2&caipiaoid=76&issueno=&start=0&num=20";
     ...
     * 底部导航栏的图片选中显示
     */
    public static final int[] TAB_SELECT_IMGS = new int[]{R.mipmap.home_select_red,  R.mipmap.discovery_select_red, R.mipmap.my_select_red};
    /**
     * TAB项的文字是否显示
     */
