...
public class CustomWheelDatePicker extends WheelDatePicker implements WheelPicker.OnItemSelectedListener,
    ...
    public CustomWheelDatePicker(Context context) {
        this(context, null);
    }

    public CustomWheelDatePicker(Context context, AttributeSet attrs) {
        super(context, attrs);
        removeAllViews();
