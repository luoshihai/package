package com.cnsunru.common.widget.gridpasswordview;
...
import com.cnsunru.common.widget.gridpasswordview.imebugfixer.ImeDelBugFixedEditText;
...
public class GridPasswordView extends LinearLayout implements PasswordView {
    ...
    private void inflaterViews(Context context) {
        ...
        inflater.inflate(R.layout.layout_grid_password_view, this);
        ...
        while (index < mPasswordLength) {
            View dividerView = inflater.inflate(R.layout.layout_grid_password_divider, null);
            ...
            TextView textView = (TextView) inflater.inflate(R.layout.layout_grid_password_view_text, null);
