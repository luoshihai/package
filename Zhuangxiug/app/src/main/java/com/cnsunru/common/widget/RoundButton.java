...
public final class RoundButton extends AppCompatTextView {
    ...
    private final float pressedRatio;
    private final int strokeColor;
    private final int strokeWidth;
    private final int strokeDashWidth;
    private final int strokeDashGap;
    ...
    public RoundButton(Context context, AttributeSet attrs, int defStyle) {
        ...
        boolean isDefaultGravityCenter = a.getBoolean(R.styleable.RoundButton_defaultGravityCenter, true);
        a.recycle();
        setSingleLine(true);

        if (isDefaultGravityCenter) {
            setGravity(Gravity.CENTER);
        }
        setRoundDrawable(pressedRatio, solidColor, strokeColor, strokeWidth, strokeDashWidth, strokeDashGap);
    }

    public void setRoundDrawable(ColorStateList solidColor) {
        setRoundDrawable(pressedRatio, solidColor, strokeColor, strokeWidth, strokeDashWidth, strokeDashGap);
    }

    public void setRoundDrawable(float pressedRatio, ColorStateList solidColor, int strokeColor, int strokeWidth, int strokeDashWidth, int strokeDashGap) {
