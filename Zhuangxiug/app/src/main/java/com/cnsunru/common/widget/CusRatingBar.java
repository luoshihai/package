...
public class CusRatingBar extends LinearLayout {
     ...
     * @param attrs
     */
    public CusRatingBar(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        TypedArray mTypedArray = context.obtainStyledAttributes(attrs, R.styleable.CusRatingBar);
        starImageSize = mTypedArray.getDimension(R.styleable.CusRatingBar_starImageSize, 20);
        starPadding = mTypedArray.getDimension(R.styleable.CusRatingBar_starPadding, 10);
        starStep = mTypedArray.getFloat(R.styleable.CusRatingBar_starStep, 1.0f);
        stepSize = StepSize.fromStep(mTypedArray.getInt(R.styleable.CusRatingBar_stepSize, 1));
        starCount = mTypedArray.getInteger(R.styleable.CusRatingBar_starCount, 5);
        starEmptyDrawable = mTypedArray.getDrawable(R.styleable.CusRatingBar_starEmpty);
        starFillDrawable = mTypedArray.getDrawable(R.styleable.CusRatingBar_starFill);
        starHalfDrawable = mTypedArray.getDrawable(R.styleable.CusRatingBar_starHalf);
        mClickable = mTypedArray.getBoolean(R.styleable.CusRatingBar_clickable, true);
        mTypedArray.recycle();
    ...
    public CusRatingBar(Context context, AttributeSet attrs, int defStyleAttr) {
