...
/**
 * Created by cnsunrun on 2017-07-18.
 */

public class WordNumberEditText extends RelativeLayout {
    ...
    private int MaxNum = 255;//最大字符

    public WordNumberEditText(Context context) {
        this(context, null);
    }

    public WordNumberEditText(Context context, AttributeSet attrs) {
        super(context, attrs);
        LayoutInflater.from(context).inflate(R.layout.wordnumber_edittext_count, this, true);
     ...
     * @return
     */
    public WordNumberEditText show(){
     ...
     * @return
     */
    public WordNumberEditText setLineColor(String color){
     ...
     * @return
     */
    public WordNumberEditText setType(String type){
        TYPES = type;
        return this;
    }
     ...
     * @return
     */
    public WordNumberEditText setLength(int num){
        this.MaxNum = num;
        return this;
    }
     ...
     * @return
     */
    public WordNumberEditText setEtHint(String str){
     ...
     * @return
     */
    public WordNumberEditText setEtMinHeight(int px){
