package com.qqq.asdas.DQDApi;

import com.qqq.asdas.DQDApi.model.LaunchImg;
import com.qqq.asdas.DQDApi.model.coach.Coach;
import com.qqq.asdas.DQDApi.model.leagueRanking.LeagueRanking;
import com.qqq.asdas.DQDApi.model.twins.Twins;
import com.qqq.asdas.DQDApi.model.PersonRanking;
...
import com.qqq.asdas.DQDApi.model.TeamMembers;
import com.qqq.asdas.DQDApi.model.TeamSchedule;
import com.qqq.asdas.DQDApi.model.news.News;
import com.qqq.asdas.DQDApi.model.search.Search;
import com.qqq.asdas.DQDApi.model.specialNews.SpecialNews;
import com.qqq.asdas.DQDApi.model.specialNewsColumn.SpecialNewsColumn;
...
public interface APIService {
    ...
    Observable<PersonRanking> getPersonRanking(@Path("number") String number, @Query("type") String type);
    ...
    Observable<News> getNews(@Path("number") String number);

    @GET
    Observable<News> getMoreNews(@Url String url);
