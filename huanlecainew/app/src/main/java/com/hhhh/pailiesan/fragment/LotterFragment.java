...
import com.hhhh.pailiesan.adapter.LotteryResultAdapter;
...
public class LotterFragment extends KBaseFragment implements SwipeRefreshLayout.OnRefreshListener {
    ...
    private void initView(){
        ...
        rcyResult.setLayoutManager(layoutManager);
        adapter = new LotteryResultAdapter(getActivity());
        rcyResult.setAdapter(adapter);
                    ...
                    if(result!=null&&!"".equals(result)){
                        try {
                            ...
                            for(int i = 0;i<jsonArray.length();i++){
                                ...
                                if("ssq".equals(object.getString("name"))||"dlt".equals(object.getString("name"))||"3d".equals(object.getString("name"))||
                                        "pls".equals(object.getString("name"))||"plw".equals(object.getString("name"))||"qlc".equals(object.getString("name"))||"qxc".equals(object.getString("name"))){
                                        bean.add(model);
                                }
                            }
