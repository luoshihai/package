...
public class AllMatchFragment extends KBaseFragment implements SwipeRefreshLayout.OnRefreshListener {
    ...
    private void getData(){
        ...
        final Request request = new Request.Builder()
                ...
                .url("http://live.zhuoyicp.com/api/fscore?issue=&uid=&mtype=all").build();
