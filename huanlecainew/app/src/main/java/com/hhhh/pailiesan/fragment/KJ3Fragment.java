...
public class KJ3Fragment extends KBaseFragment implements SwipeRefreshLayout.OnRefreshListener {
                    ...
                    if(result!=null&&!"".equals(result)){
                        try {
                            ...
                            for(int i = 0;i<jsonArray.length();i++){
                                ...
                                if("k3".equals(object.getString("name"))||"gd115".equals(object.getString("name"))||"sd115".equals(object.getString("name"))||
                                        "xj115".equals(object.getString("name"))||"cqssc".equals(object.getString("name"))||"jlk3".equals(object.getString("name"))){
                                    bean.add(model);
                                }
                            }
