...
import com.hhhh.pailiesan.utils.CameraUtil;
...
public class PersonInfoActivity extends KBaseActivity {
    ...
    protected void initView() {
        super.initView();
        tvMyName.setText((String) UserCacheData.get(PersonInfoActivity.this, "name", getResources().getString(R.string.app_name)));
