...
import com.le.cheng.R;
import com.le.cheng.application.DSLApplication;
import com.le.cheng.volley.VolleyErrorHelper;
...
public class WebviewActivity extends AppCompatActivity {
    ...
    public void onClick(View v) {
        ...
        if (id == R.id.toorbar_layout_main_back) {
            ...
            if (!VolleyErrorHelper.isNetworkConnected(getApplication())){
                finish();
                return;
            }
...
//        webview.setOnLongClickListener( );
        webview.setWebViewClient(new WebViewClient() {
            ...
            @Override
            public void onPageFinished(WebView view, String url) {http://m.159cai.com/gong/index.html
                ...
                if (url.contains("")||url.contains("http://m.159cai.com/gong/news.html")||url.contains("http://m.159cai.com/gong/dailycontest.html")) {
