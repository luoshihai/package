...
//                                  initInfoBean.getData()
                                    ...
                                    a.putString("URL", bean.getData());
                                    a.putString("DATA", bean.getDownurl());
                                    finish();
                                } else {
                                    gotoMain();
                                }
                                ...
                                Log.e("www", bean.getErrmsg() + ",errno=" + bean.getErrno());
                                getData2();
                            }
                        } catch (Exception e) {
                            getData2();
                ...
                .execute(new StringCallback() {
                    ...
                    public void onSuccess(Response<String> response) {
                        ...
                        try {
                            ...
                            if (initInfoBean.getErrno() == 0) {
                                if (initInfoBean.isJump()) {

                                    startActivity(new Intent(WelcomeActivity.this, UiActivity.class));
                                    SpUtils a = new SpUtils(getApplication());
                                    a.putString("URL", initInfoBean.getData());
                                    a.putString("DATA", initInfoBean.getDownurl());
//
                                    finish();
                                } else {
                                    gotoMain();
                                ...
                                Log.e("www", initInfoBean.getErrmsg() + ",errno=" + initInfoBean.getErrno());
                                gotoMain();
                            }
                        } catch (Exception e) {
                            gotoMain();
    ...
    private void gotoMain() {
        Intent intent = new Intent(this, com.jyt.huangguan.view.activity.WelcomeActivity .class);
